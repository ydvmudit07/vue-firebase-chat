<template>
          ...
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                <button type="button" class="relative rounded-full cursor-not-allowed bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
        ...
        <DisclosurePanel class="md:hidden">
          ...
          <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="https://st4.depositphotos.com/3557671/23892/v/450/depositphotos_238923408-stock-illustration-vector-illustration-of-avatar-and.jpg" alt="" />
              </div>
              <div class="ml-3">
  ...
  const navigation = [
    ...
    { name: 'Github', href: 'https://github.com/ydvmudit07', current: false},
    { name: 'Discord', href: 'https://discord.gg/Rga4253K', current: false},
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/ydvmudit07/', current: false},
  ]
  const userNavigation = [
    { name: 'Welcome to MooChat', href: '#' },
    // { name: 'Settings', href: '#' },
    // { name: 'Sign out', href: '#' },
  ]
  </script>