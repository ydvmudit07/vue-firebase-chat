<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-12 sm:py-32 pl-16 sm:h-full">
      ...
      <div class="mx-auto max-w-7xl">
        <div class="mx-auto max-w-4xl lg:mx-0">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">At MooChat, conversations spark change. New ideas emerge and communities unite as users share and discuss what matters most to them. Join our community, share your voice, and help start something big. Our platform makes it easy to connect with people who share your interests and passions. Search among thousands of communities around any topic or start your own group focused on a cause you care about.</p>
        </div>
      </div>
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2 pt-24 pr-16">
          <div class="max-w-xl lg:max-w-lg">
            ...
            <div class="mt-6 flex max-w-md gap-x-4">
              ...
              <input id="email-address" v-model="email" name="email" type="email" autocomplete="email" class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="Enter your email" />
          ...
          <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div class="flex flex-col items-start">
              ...
              <dd class="mt-2 leading-7 text-gray-400 w-[16rem]">The Moosletter delivers our favourite features and community stories to your inbox each week.</dd>
            </div>
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
